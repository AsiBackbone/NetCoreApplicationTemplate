...
For release-level rollback and hotfix policy, see [Release Checklist](https://github.com/AsiBackbone/NetCoreApplicationTemplate/blob/main/.github/RELEASE.md).
